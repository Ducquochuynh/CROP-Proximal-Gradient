function [x, info, acc] = crop_pg_lasso(A, b, lambda, x0, gamma, delta, m, maxit, tol)
% CROP_PG_LASSO: CROP Proximal Gradient Algorithm for LASSO (Inexact Residual)
%
%   [x, info, acc] = crop_pg_lasso(A, b, lambda, x0, gamma, delta, m, maxit, tol)
%
%   Implements the CROP-PG method for solving the LASSO problem:
