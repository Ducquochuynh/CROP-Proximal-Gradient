function [x, info, acc] = crop_pg_nrr(A, b, lambda, x0, gamma, delta, m, maxit, tol)
% CROP_PG_NRR: CROP Proximal-Gradient Algorithm for Nonnegative
% Ridge Regression (Inexact Residual)
%
%   Solves:  minimize 0.5*||A*x - b||^2 + 0.5*lambda*||x||^2   subject to x >= 0
%
%   [x, info, acc] = crop_pg_nrr(A,b,lambda,x0,gamma,delta,m,maxit,tol)
%
