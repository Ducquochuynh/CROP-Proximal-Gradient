function [x, info, acc] = crop_pg_logistic_l1_exact(A, b, lambda, x0, gamma, delta, m, maxit, tol)
% CROP_PG_LOGISTIC_L1_EXACT: GROP for L1-Regularized Logistic Regression (Exact Residual)
%
%   [x, info, acc] = crop_pg_logistic_l1_exact(A, b, lambda, x0, gamma, delta, m, maxit, tol)
%
...
for k_iter = 1:maxit
    ...
    x_k = x_new; y_k = y_new; F_k = F_new; phik = phi_new; gradk = grad_new;  
