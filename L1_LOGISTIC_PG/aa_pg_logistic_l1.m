function [x, info, acc] = aa_pg_logistic_l1(A, b, lambda, x0, gamma, m, maxit, tol, opts)
% AA_PG_LOGISTIC_L1: AA-PG for L1-Regularized Logistic Regression
%
%   [x, info, acc] = aa_pg_logistic_l1(A, b, lambda, x0, gamma, m, maxit, tol, opts)
%
